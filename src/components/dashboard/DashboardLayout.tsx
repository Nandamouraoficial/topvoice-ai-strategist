...
import { mockProfile, mockAnalysisReport } from "@/lib/mock-data";
...
export default function DashboardLayout({ children, activeTab, onTabChange, onLogout }: DashboardLayoutProps) {
  ...
  const rank = mockAnalysisReport.rank;
    ...
    <div className="min-h-screen flex bg-surface">
      ...
      >
        ...
        <div className="p-5 border-b border-navy-700">
          <div className="flex items-center gap-2">
            <div className="w-9 h-9 rounded-xl gold-gradient flex items-center justify-center text-sm font-bold text-navy-950">
              TV
            </div>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all
                ${activeTab === item.id
                  ...
                  : "text-muted-foreground hover:text-platinum hover:bg-navy-800"
                }`}
            >
        ...
        <div className="p-4 border-t border-navy-700">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-semibold text-platinum truncate">{profile.firstName}</div>
          ...
          <button
            onClick={onLogout}
            className="mt-3 w-full text-xs text-muted-foreground hover:text-destructive transition-colors text-left"
          >
            Sair
          </button>
        </div>
      ...
      <div className="flex-1 min-w-0">
        ...
        <header className="md:hidden sticky top-0 z-30 bg-surface/95 backdrop-blur-sm border-b border-border p-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg gold-gradient flex items-center justify-center text-xs font-bold text-navy-950">
              TV
            </div>
